...
### 6. 주문 완료 화면 (Order Complete Screen)
![주문 완료 화면](./docs/images/kiosk_6_complete.png)
* 음료 제조가 완전히 종료되고 사용자가 컵 수령(`CUP_STATUS = 0`)까지 마친 상태의 최종 화면입니다. 컵이 센서 감지 영역에서 안전하게 이탈되면 최종 100% 완료 상태로 상태 바가 차오르며, 홈 화면으로 돌아가 새 주문을 시작할 수 있는 트리거 버튼이 활성화됩니다.
